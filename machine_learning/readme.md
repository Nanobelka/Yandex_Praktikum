# [Прогнозирование оттока клиентов фитнесс-центра (машинное обучение)](https://github.com/Nanobelka/Yandex_Praktikum/blob/main/machine_learning/machine_learning.ipynb)
